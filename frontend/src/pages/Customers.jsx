                    ...
                    <td className="py-3 px-4" onClick={e => e.stopPropagation()}>
                      {canDelete ? (
                        <button onClick={() => setDeleteCustomer({ id: c.id, name: c.name, step: 1 })}
                          className="text-xs text-red-500 hover:text-red-700 font-medium px-2 py-1 rounded hover:bg-red-50 border border-red-100">
                          🗑 Delete
                        </button>
                      ) : isEditor ? (
                        <button onClick={() => setRequestDelete({ id: c.id, name: c.name })}
                          className="text-xs text-amber-600 hover:text-amber-800 font-medium px-2 py-1 rounded hover:bg-amber-50 border border-amber-200">
                          🗑 Request
                        </button>
                      ) : null}
                    </td>
